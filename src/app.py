...
title = ctk.CTkLabel(
    app, text="NEURAL THREAT ANALYZER",
    font=("Courier", 24, "bold"), text_color="#00FF00"
)
title.pack(pady=(30, 5))

subtitle = ctk.CTkLabel(
    app, text="Input text payload or email content for NLP classification",
    font=("Courier", 11)
)
subtitle.pack(pady=(0, 15))

textbox = ctk.CTkTextbox(
    app, width=600, height=160,
    font=("Courier", 13), fg_color="#1E1E1E",
    border_color="#00FF00", border_width=1
)
textbox.pack(pady=8)

analyze_btn = ctk.CTkButton(
    app, text="INITIALIZE SCAN",
    font=("Courier", 16, "bold"),
    command=analyze_input,
    fg_color="#005500", hover_color="#00AA00"
)
analyze_btn.pack(pady=16)

result_label = ctk.CTkLabel(
    app, text="STATUS: Awaiting Payload...",
...
prob_label = ctk.CTkLabel(
    app, text="",
    font=("Courier", 10), text_color="#888888"
)
